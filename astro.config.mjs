          ...
          items: [
            {
              ...
              translations: nav.installation,
            },
            {
              label: "Quickstart",
              slug: "docs/getting-started/quickstart",
              translations: nav.quickstart,
            },
            {
              label: "Your first workflow",
              slug: "docs/getting-started/first-workflow",
              translations: nav.firstWorkflow,
            },
          ],
        },
        {
          ...
          items: [
            {
              label: "Composition over vendoring",
              slug: "docs/concepts/composition",
              translations: nav.composition,
            },
            {
              label: "The three-layer stack",
              slug: "docs/concepts/three-layer-stack",
              translations: nav.threeLayer,
            },
            {
              label: "The 5-stage cadence",
              slug: "docs/concepts/five-stage-cadence",
              translations: nav.cadence,
            },
            {
              label: "Dogfood-first methodology",
              slug: "docs/concepts/dogfood-first",
              translations: nav.dogfood,
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              slug: "docs/reference/workflows",
              translations: nav.workflows,
            },
            {
              label: "Manifest schema",
              slug: "docs/reference/manifest-schema",
              translations: nav.manifest,
            },
