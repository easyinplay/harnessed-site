...
const ptBr: Dict = {
  ...
  threeLayerStack: {
    ...
    intersections: {
      ...
      items: [
        {
          name: "GSD",
          body: "é a espinha dorsal, atravessando os três anéis — discuss, plan, verify.",
        },
      ...
      items: [
        {
          ...
          body: "how to code — a menor mudança viável, edições cirúrgicas.",
        },
        {
          name: "mattpocock moves",
          body: "ferramentas sob demanda, invocadas conforme a situação.",
        },
      ],
    },
    runtime: {
  ...
  workflowSection: {
    ...
    subheading:
      "Cada estágio compõe ferramentas comprovadas de todo o ecossistema de harnesses de programação com IA.",
    stages: {
  ...
  quickstart: {
    ...
    steps: [
      ...
      },
      {
        ...
        caption:
          "Rode dentro do seu agent de programação com IA. O pipeline de 6 estágios assume daí.",
      },
    ],
  },
  communityStats: {
  ...
  footer: {
    tagline:
      "Gerenciador de pacotes + orquestrador de composição para harnesses de programação com IA.",
    resources: "Recursos",
