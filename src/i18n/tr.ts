...
const tr: Dict = {
  ...
  threeLayerStack: {
    ...
    intersections: {
      ...
      items: [
        { name: 'GSD', body: 'omurgadır; discuss, plan ve verify ile üç halkayı da baştan sona geçer.' },
        { name: 'gstack', body: 'Behavior + Review’ı kapsar.' },
        { name: 'superpowers', body: 'Behavior (brainstorm) + Implementation (TDD) alanlarını kapsar.' },
      ],
    },
    crossCutting: {
      ...
      items: [
        { name: 'karpathy principles', body: 'how to code — mümkün olan en küçük değişiklik, cerrahi düzenlemeler.' },
  ...
  workflowSection: {
    ...
    subheading: 'Her aşama, yapay zekâ kodlama harness ekosisteminden kanıtlanmış araçları birleştirir.',
    stages: {
