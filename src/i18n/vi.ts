...
const vi: Dict = {
  ...
  threeLayerStack: {
    ...
    crossCutting: {
      ...
      items: [
        { name: 'karpathy principles', body: 'how to code — thay đổi khả thi nhỏ nhất, chỉnh sửa như phẫu thuật.' },
  ...
  workflowSection: {
    ...
    subheading: 'Mỗi giai đoạn kết hợp các công cụ đã được kiểm chứng từ khắp hệ sinh thái harness lập trình AI.',
    stages: {
