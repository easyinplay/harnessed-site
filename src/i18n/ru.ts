...
const ru: Dict = {
  ...
  threeLayerStack: {
    ...
    intersections: {
      ...
      items: [
        { name: 'GSD', body: '— несущая ось, проходит через все три кольца: discuss, plan, verify.' },
    ...
    crossCutting: {
      ...
      items: [
        { name: 'karpathy principles', body: 'how to code — минимальное жизнеспособное изменение, точечные правки.' },
  ...
  workflowSection: {
    ...
    subheading: 'Каждая стадия собирает проверенные инструменты со всей экосистемы AI-харнессов разработки.',
    stages: {
  ...
  quickstart: {
    ...
    steps: [
      ...
      },
      {
        ...
        caption: 'Запустите внутри вашего AI-агента разработки. Конвейер из 6 стадий берёт дело на себя.',
      },
    ],
  },
  communityStats: {
