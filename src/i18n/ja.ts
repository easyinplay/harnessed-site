...
const ja: Dict = {
  ...
  threeLayerStack: {
    ...
    intersections: {
      ...
      items: [
        { name: 'GSD', body: 'は backbone で、discuss・plan・verify と 3 つのリングすべてを貫きます。' },
        { name: 'gstack', body: 'は Behavior + Review にまたがります。' },
        { name: 'superpowers', body: 'は Behavior（brainstorm）+ Implementation（TDD）にまたがります。' },
      ],
    },
    crossCutting: {
      label: '横断する規律',
      ...
      items: [
        { name: 'karpathy principles', body: 'how to code —— 最小限の実行可能な変更、外科手術的な編集。' },
  ...
  workflowSection: {
    ...
    subheading: '各段階が AI コーディング harness エコシステム全体から実証済みのツールを合成します。',
    stages: {
